...
public class PermissionInitializer
{
    ...
    public async Task InitializePermissions()
    {
        List<Permission> permissions = new()
            {
                new Permission () { Id = PermissionId.READ_ARTICLES, PermissionName = PermissionNames.READ_ARTICLES, RoleIds = new List<string> {RoleId.USER, RoleId.AUTHOR, RoleId.SUPER_ADMIN}},
                new Permission () { Id = PermissionId.EDIT_ARTICLES, PermissionName = PermissionNames.EDIT_ARTICLES, RoleIds = new List<string> {RoleId.AUTHOR, RoleId.SUPER_ADMIN}},
