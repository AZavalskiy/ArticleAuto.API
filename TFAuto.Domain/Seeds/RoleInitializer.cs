...
namespace TFAuto.Domain.Seeds
{
    public class RoleInitializer
    {
        ...
        public async Task InitializeRoles()
        {
            List<Role> roles = new()
            {
                new Role () { Id = RoleId.SUPER_ADMIN, RoleName = RoleNames.SUPER_ADMIN,  PermissionIds = new List<string> {PermissionId.MANAGE_ARTICLES, PermissionId.MANAGE_ROLES, PermissionId.EDIT_ARTICLES}},
